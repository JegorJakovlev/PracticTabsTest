function openTab(tabName) {
  ...
  indicator.style.marginLeft = tabButton.offsetLeft + tabButton.offsetWidth / 4 - indicator.offsetWidth / 2 + "px";

  const tabsContainer = document.querySelector(".tabs");
  const persistentLine = document.createElement("div");
  persistentLine.classList.add("persistent-line");
  tabsContainer.appendChild(persistentLine);
